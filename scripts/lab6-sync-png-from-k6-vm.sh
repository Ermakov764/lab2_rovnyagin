#!/usr/bin/env bash
# -----------------------------------------------------------------------------
# Зачем: lab6 — одним махом забрать results/ с k6-ВМ и построить lab6-vs-cpu-*.png в png_k6/.
# Когда: закончили run-lab6-ratio-sweep на удалённой машине и хотели графики у себя без ручного scp+python.
# Где: с локального ПК из корня lab2_rovnyagin. SSH/порт как у k6-ВМ (K6_SSH_* или hlssh.zil.digital:2311).
# Типовой сценарий: export BASE_URL=… LAB6_PLOT_VUS=…; ./scripts/lab6-sync-png-from-k6-vm.sh
